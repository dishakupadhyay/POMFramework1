...
public class BasePage {
    ...
    /** This method is used to initialise driver on the basis of browser name.
     * @param browserName
     * @return
     */
    ...
    public WebDriver initialiseDriver(String browserName) {
        if (browserName.equals("chrome")) {
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\Keyur\\IdeaProjects\\POMFramework1\\src\\test\\" +
                    "resources\\BrowserDriver\\chromedriver.exe");
            driver = new ChromeDriver();

        } else if (browserName.equals("firefox")) {
            System.setProperty("webdriver.gecko.driver", "C:\\Users\\Keyur\\IdeaProjects\\POMFramework1\\src\\test\\" +
                    "resources\\BrowserDriver\\geckodriver.exe");
            driver = new FirefoxDriver();

        } else if (browserName.equals("internetexplorer")) {
            System.setProperty("webdriver.ie.driver", "C:\\Users\\Keyur\\IdeaProjects\\POMFramework1\\src\\test\\" +
    ...
    public Properties initialiseProperties() {
        ...
        try {
            file = new FileInputStream("C:\\Users\\Keyur\\IdeaProjects\\POMFramework1\\src\\test\\resources\\" +
